...
class AnagramsSuite extends FunSuite {
  ...
  test("wordOccurrences: emptyString") {
  ...
  test("sentenceOccurrences: empty string") {
    assert(sentenceOccurrences(List()) === List())
  }

  test("sentenceOccurrences: AdEA") {
    assert(sentenceOccurrences(List("AdEA")) === List(('a', 2), ('d', 1), ('e', 1)))
  }
